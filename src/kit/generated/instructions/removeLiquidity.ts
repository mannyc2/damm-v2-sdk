...
> = {
  ...
  liquidityDelta: RemoveLiquidityInstructionDataArgs["liquidityDelta"];
  tokenAAmountThreshold: RemoveLiquidityInstructionDataArgs["tokenAAmountThreshold"];
  tokenBAmountThreshold: RemoveLiquidityInstructionDataArgs["tokenBAmountThreshold"];
};
