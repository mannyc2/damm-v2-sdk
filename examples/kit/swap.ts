...
(async () => {
  ...
  const plan = await client.swap({
    payer,
    pool: address("AfSNTGm4nGoQz5ZiDoZRwdYkFZMUr9nudMST8cTQL8Vb"),
    inputTokenMint: address("So11111111111111111111111111111111111111112"),
    outputTokenMint: address("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"),
