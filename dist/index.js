...
var getTokenDecimals = (connection, mint, tokenProgram) => _chunkANN74BKIjs.__async.call(void 0, null, null, function* () {
  return (yield _spltoken.getMint.call(void 0, connection, mint, "confirmed", tokenProgram)).decimals;
});
var getOrCreateATAInstruction = (_0, _1, ..._2) => _chunkANN74BKIjs.__async.call(void 0, null, [_0, _1, ..._2], function* (tokenMint, owner, payer = owner, allowOwnerOffCurve = true, tokenProgram) {
...
var unwrapSOLInstruction = (_0, ..._1) => _chunkANN74BKIjs.__async.call(void 0, null, [_0, ..._1], function* (owner, receiver = owner, allowOwnerOffCurve = true) {
...
var getSimulationComputeUnits = (connection, instructions, payer, lookupTables, commitment = "confirmed") => _chunkANN74BKIjs.__async.call(void 0, null, null, function* () {
  var _a, _b, _c;
...
var getEstimatedComputeUnitUsageWithBuffer = (connection, instructions, feePayer, buffer) => _chunkANN74BKIjs.__async.call(void 0, null, null, function* () {
  if (!buffer) {
    buffer = 0.1;
  }
...
var getEstimatedComputeUnitIxWithBuffer = (connection, instructions, feePayer, buffer) => _chunkANN74BKIjs.__async.call(void 0, null, null, function* () {
...
var getPriceFromSqrtPrice = (sqrtPrice, tokenADecimal, tokenBDecimal) => {
  ...
  const price = decimalSqrtPrice.mul(decimalSqrtPrice).mul(new (0, _decimaljs2.default)(_chunkANN74BKIjs.__pow.call(void 0, 10, tokenADecimal - tokenBDecimal))).div(_decimaljs2.default.pow(2, 128));
  return price;
};
var getSqrtPriceFromPrice = (price, tokenADecimal, tokenBDecimal) => {
  const decimalPrice = new (0, _decimaljs2.default)(price);
  const adjustedByDecimals = decimalPrice.div(
    new (0, _decimaljs2.default)(_chunkANN74BKIjs.__pow.call(void 0, 10, tokenADecimal - tokenBDecimal))
  );
...
function getTotalLockedLiquidity(vestingData) {
  return vestingData.innerVesting.cliffUnlockLiquidity.add(
    vestingData.innerVesting.liquidityPerPeriod.mul(
      new (0, _anchor.BN)(vestingData.innerVesting.numberOfPeriod)
    )
  );
}
...
function getFeeInPeriod(cliffFeeNumerator, reductionFactor, passedPeriod) {
  ...
  if (result.gt(U128_MAX)) {
    throw new (0, _chunkANN74BKIjs.MathOverflowError)();
  }
...
function getFeeMode(collectFeeMode, tradeDirection, hasReferral) {
  ...
  switch (collectFeeMode) {
    ...
    case 2 /* Compounding */:
      ...
      break;
    default:
      throw new (0, _chunkANN74BKIjs.InvalidCollectFeeModeError)();
  }
  return {
    feesOnInput,
    feesOnTokenA,
...
function splitFees(poolFees, feeAmount, hasReferral) {
  let protocolFee = mulDiv(
    feeAmount,
    new (0, _anchor.BN)(poolFees.protocolFeePercent),
    new (0, _anchor.BN)(100),
    1 /* Down */
  );
  let tradingFee = feeAmount.sub(protocolFee);
  const compoundingFeeBps = new (0, _anchor.BN)(poolFees.compoundingFeeBps);
  let compoundingFee;
  let claimingFee;
  if (compoundingFeeBps.gt(new (0, _anchor.BN)(0))) {
    ...
    compoundingFee = new (0, _anchor.BN)(0);
  ...
  if (hasReferral) {
    referralFee = mulDiv(
      protocolFee,
      new (0, _anchor.BN)(poolFees.referralFeePercent),
      new (0, _anchor.BN)(100),
      1 /* Down */
    );
  } else {
    referralFee = new (0, _anchor.BN)(0);
  }
...
function getIncludedFeeAmount(tradeFeeNumerator, excludedFeeAmount) {
  ...
  if (denominator.isZero() || denominator.isNeg()) {
    throw new (0, _chunkANN74BKIjs.InvalidFeeError)("Fee denominator must be positive and non-zero");
  }
...
function getMaxFeeNumerator(feeVersion) {
  switch (feeVersion) {
    ...
    default:
      throw new (0, _chunkANN74BKIjs.InvalidPoolVersionError)();
  }
}
...
function getMaxIndex(maxFeeBps, cliffFeeNumerator, feeIncrementBps) {
  ...
  if (cliffFeeNumerator.gt(maxFeeNumerator)) {
    throw new (0, _chunkANN74BKIjs.InvalidInputError)(
  ...
  if (feeIncrementNumerator.isZero()) {
    throw new (0, _chunkANN74BKIjs.InvalidInputError)("feeIncrementNumerator cannot be zero");
  }
...
function getFeeNumeratorFromIncludedFeeAmount(inputAmount, referenceAmount, cliffFeeNumerator, maxFeeBps, feeIncrementBps) {
  if (inputAmount.lte(referenceAmount)) {
    ...
    if (numerator.gt(new (0, _bnjs2.default)(U64_MAX))) {
      throw new (0, _chunkANN74BKIjs.MathOverflowError)("Numerator does not fit in u64");
    }
    return numerator;
  }
}
...
function getFeeNumeratorFromExcludedFeeAmount(excludedFeeAmount, referenceAmount, cliffFeeNumerator, maxFeeBps, feeIncrementBps) {
  ...
  if (feeNumerator.lt(cliffFeeNumerator)) {
    throw new (0, _chunkANN74BKIjs.InvalidInputError)("feeNumerator is less than cliffFeeNumerator");
  }
  return feeNumerator;
}
...
function getFeeTimeBaseFeeNumeratorByPeriod(cliffFeeNumerator, numberOfPeriod, period, reductionFactor, feeTimeSchedulerMode) {
  ...
  switch (feeTimeSchedulerMode) {
    ...
    default:
      throw new (0, _chunkANN74BKIjs.InvalidBaseFeeModeError)("Invalid fee time scheduler mode");
  }
}
...
function getFeeMarketCapBaseFeeNumeratorByPeriod(cliffFeeNumerator, numberOfPeriod, period, reductionFactor, feeMarketCapSchedulerMode) {
  ...
  switch (feeMarketCapSchedulerMode) {
    ...
    default:
      throw new (0, _chunkANN74BKIjs.InvalidBaseFeeModeError)(
...
function getInitialCompoundingPoolInformation(sqrtPrice, liquidity) {
  ...
  return {
    ...
    sqrtMinPrice: new (0, _bnjs2.default)(0),
...
function calculateAtoBFromAmountOutForCompoundingLiquidity(tokenAAmount, tokenBAmount, amountOut) {
  if (amountOut.gte(tokenBAmount)) {
    throw new (0, _chunkANN74BKIjs.InsufficientLiquidityError)();
  }
...
function getSqrtPriceFromAmountsForCompoundingLiquidity(tokenAAmount, tokenBAmount) {
  ...
  if (!sqrtPrice) {
    throw new (0, _chunkANN74BKIjs.MathOverflowError)("MathOverflow in getSqrtPriceFromAmounts");
  }
  return sqrtPrice;
}
...
function calculateAtoBFromAmountInForConcentratedLiquidity(sqrtMinPrice, sqrtPrice, liquidity, amountIn) {
  ...
  if (nextSqrtPrice.lt(sqrtMinPrice)) {
    throw new (0, _chunkANN74BKIjs.PriceRangeViolationError)();
  }
...
function getAmountAFromLiquidityDeltaForConcentratedLiquidity(lowerSqrtPrice, upperSqrtPrice, liquidity, rounding) {
  ...
  if (denominator.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.MathOverflowError)("Denominator must be greater than zero");
  }
...
function getNextSqrtPriceFromInput(sqrtPrice, liquidity, amountIn, aForB) {
  if (sqrtPrice.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.InvalidInputError)("sqrtPrice must be greater than 0");
  }
  if (liquidity.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.InvalidInputError)("liquidity must be greater than 0");
  }
  if (aForB) {
...
function getNextSqrtPriceFromAmountOutARoundingUp(sqrtPrice, liquidity, amount) {
  ...
  if (denominator.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.MathOverflowError)("Denominator is zero or negative");
  }
...
function getNextSqrtPriceFromAmountOutBRoundingDown(sqrtPrice, liquidity, amount) {
  ...
  if (result.isNeg()) {
    throw new (0, _chunkANN74BKIjs.MathOverflowError)("sqrt price cannot be negative");
  }
  return result;
}
...
function calculateInitSqrtPrice(tokenAAmount, tokenBAmount, minSqrtPrice, maxSqrtPrice) {
  if (tokenAAmount.isZero() || tokenBAmount.isZero()) {
    throw new (0, _chunkANN74BKIjs.AmountIsZeroError)("Amount cannot be zero");
  }
...
function swapQuoteExactInput(pool, currentPoint, amountIn, slippage, aToB, hasReferral, tokenADecimal, tokenBDecimal, inputTokenInfo, outputTokenInfo) {
  if (amountIn.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.AmountIsZeroError)("Amount in must be greater than 0");
  }
  if (!isSwapEnabled(pool, currentPoint)) {
    throw new (0, _chunkANN74BKIjs.SwapDisabledError)();
  }
...
function swapQuoteExactOutput(pool, currentPoint, amountOut, slippage, aToB, hasReferral, tokenADecimal, tokenBDecimal, inputTokenInfo, outputTokenInfo) {
  if (amountOut.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.AmountIsZeroError)("Amount out must be greater than 0");
  }
  if (!isSwapEnabled(pool, currentPoint)) {
    throw new (0, _chunkANN74BKIjs.SwapDisabledError)();
  }
...
function validateFeeTimeScheduler(numberOfPeriod, periodFrequency, reductionFactor, cliffFeeNumerator, baseFeeMode, feeVersion) {
  if (!periodFrequency.eq(new (0, _bnjs2.default)(0)) || numberOfPeriod !== 0 || !reductionFactor.eq(new (0, _bnjs2.default)(0))) {
    if (numberOfPeriod === 0 || periodFrequency.eq(new (0, _bnjs2.default)(0)) || reductionFactor.eq(new (0, _bnjs2.default)(0))) {
      throw new (0, _chunkANN74BKIjs.InvalidFeeTimeSchedulerError)();
    }
  }
  ...
  if (minFeeNumerator.lt(new (0, _bnjs2.default)(MIN_FEE_NUMERATOR)) || maxFeeNumerator.gt(getMaxFeeNumerator(feeVersion))) {
    throw new (0, _chunkANN74BKIjs.ExceedMaxFeeBpsError)();
  }
  return true;
}
...
function validateFeeMarketCapScheduler(cliffFeeNumerator, numberOfPeriod, sqrtPriceStepBps, reductionFactor, schedulerExpirationDuration, feeMarketCapSchedulerMode, feeVersion) {
  if (reductionFactor.lte(new (0, _bnjs2.default)(0))) {
    throw new (0, _chunkANN74BKIjs.InvalidFeeMarketCapSchedulerError)();
  }
...
function validateFeeRateLimiter(cliffFeeNumerator, feeIncrementBps, maxFeeBps, maxLimiterDuration, referenceAmount, collectFeeMode, activationType, feeVersion) {
  if (collectFeeMode !== 1 /* OnlyB */) {
    throw new (0, _chunkANN74BKIjs.InvalidFeeRateLimiterError)(
  ...
  if (minFeeNumerator.lt(new (0, _bnjs2.default)(MIN_FEE_NUMERATOR)) || maxFeeNumeratorFromAmount.gt(getMaxFeeNumerator(feeVersion))) {
    throw new (0, _chunkANN74BKIjs.InvalidFeeRateLimiterError)("Fee numerator out of valid range");
  }
  return true;
}
...
function validateFeeFraction(numerator, denominator) {
  if (denominator.isZero() || numerator.gte(denominator)) {
    throw new (0, _chunkANN74BKIjs.InvalidFeeError)();
  }
}
...
function validateActivationType(activationType) {
  ...
  if (!allowed.includes(activationType)) {
    throw new (0, _chunkANN74BKIjs.InvalidActivationTypeError)();
  }
}
function validatePriceRange(collectFeeMode, sqrtMinPrice, sqrtMaxPrice) {
  ...
  if (sqrtMinPrice.lt(MIN_SQRT_PRICE) || sqrtMaxPrice.gt(MAX_SQRT_PRICE)) {
    throw new (0, _chunkANN74BKIjs.InvalidPriceRangeError)();
  }
...
function validateCompoundingFee(collectFeeMode, compoundingFeeBps) {
  if (collectFeeMode === 2 /* Compounding */) {
    if (compoundingFeeBps <= 0 || compoundingFeeBps > BASIS_POINT_MAX) {
      throw new (0, _chunkANN74BKIjs.InvalidCompoundingFeeBpsError)();
    }
  } else {
...
function validateDynamicFee(dynamicFee) {
  if (dynamicFee.binStep !== BIN_STEP_BPS_DEFAULT) {
    throw new (0, _chunkANN74BKIjs.InvalidDynamicFeeParametersError)();
  }
...
function validateLockPositionParams(params) {
  ...
  if (numberOfPeriod > 0) {
    if (periodFrequency.lte(new (0, _bnjs2.default)(0)) || liquidityPerPeriod.lte(new (0, _bnjs2.default)(0))) {
...
var CpAmm = class {
  ...
  getDepositQuote(params) {
    ...
    if (isTokenA && sqrtPrice.gte(maxSqrtPrice)) {
      throw new (0, _chunkANN74BKIjs.DepositTokenNotAcceptedError)("B");
    }
    if (!isTokenA && sqrtPrice.lte(minSqrtPrice)) {
      throw new (0, _chunkANN74BKIjs.DepositTokenNotAcceptedError)("A");
    }
