...
interface BaseFeeHandler {
    validate(collectFeeMode: CollectFeeMode, activationType: ActivationType, feeVersion: number): boolean;
...
interface SwapAmountFromOutput {
    inputAmount: BN;
    nextSqrtPrice: BN;
}
...
declare class CpAmm {
     ...
     */
    getStaticConfigs(): Promise<Array<{
        publicKey: PublicKey;
        account: ConfigState;
    }>>;
    /**
...
declare class DepositTokenNotAcceptedError extends Error {
    readonly acceptedToken: "A" | "B";
    constructor(acceptedToken: "A" | "B");
}
declare class InvalidFeeError extends Error {
    constructor(message?: string);
}
declare class ExceedMaxFeeBpsError extends Error {
    constructor(message?: string);
}
declare class InvalidActivationTypeError extends Error {
    constructor(message?: string);
}
declare class InvalidPriceRangeError extends Error {
    constructor(message?: string);
}
declare class InvalidCollectFeeModeError extends Error {
    constructor(message?: string);
}
declare class InvalidCompoundingFeeBpsError extends Error {
    constructor(message?: string);
}
declare class InvalidFeeTimeSchedulerError extends Error {
    constructor(message?: string);
}
declare class InvalidFeeMarketCapSchedulerError extends Error {
    constructor(message?: string);
}
declare class InvalidFeeRateLimiterError extends Error {
    constructor(message?: string);
}
declare class InvalidDynamicFeeParametersError extends Error {
    constructor(message?: string);
}
declare class InvalidMinimumLiquidityError extends Error {
    constructor(message?: string);
}
declare class AmountIsZeroError extends Error {
    constructor(message?: string);
}
declare class InvalidBaseFeeModeError extends Error {
    constructor(message?: string);
}
declare class InvalidPoolVersionError extends Error {
    constructor(message?: string);
}
declare class MathOverflowError extends Error {
    constructor(message?: string);
}
declare class InsufficientLiquidityError extends Error {
    constructor(message?: string);
}
declare class SwapDisabledError extends Error {
    constructor(message?: string);
}
declare class InvalidInputError extends Error {
    constructor(message?: string);
}
declare class PriceRangeViolationError extends Error {
    constructor(message?: string);
}
declare class SameTokenMintsError extends Error {
    constructor(message?: string);
}
declare class InvalidParametersError extends Error {
    constructor(message?: string);
}
declare class InvalidSplitPositionParametersError extends Error {
    constructor(message?: string);
}
declare class InvalidVestingInfoError extends Error {
    constructor(message?: string);
}
declare class InvalidRewardIndexError extends Error {
    constructor(message?: string);
}
declare class InvalidRewardDurationError extends Error {
    constructor(message?: string);
}
...
declare const CURRENT_POOL_VERSION = 1;
declare const DEAD_LIQUIDITY: BN$1;
 ...
 */
declare function validateFeeTimeScheduler(numberOfPeriod: number, periodFrequency: BN$1, reductionFactor: BN$1, cliffFeeNumerator: BN$1, baseFeeMode: BaseFeeMode, feeVersion: number): boolean;
/**
 ...
 */
declare function validateFeeMarketCapScheduler(cliffFeeNumerator: BN$1, numberOfPeriod: number, sqrtPriceStepBps: BN$1, reductionFactor: BN$1, schedulerExpirationDuration: BN$1, feeMarketCapSchedulerMode: BaseFeeMode, feeVersion: number): boolean;
/**
 ...
 */
declare function validateFeeRateLimiter(cliffFeeNumerator: BN$1, feeIncrementBps: number, maxFeeBps: number, maxLimiterDuration: number, referenceAmount: BN$1, collectFeeMode: CollectFeeMode, activationType: ActivationType, feeVersion: number): boolean;
/**
 ...
 */
declare function validateCollectFeeMode(collectFeeMode: number): void;
/**
 ...
 */
declare function validateActivationType(activationType: number): void;
/**
 ...
 */
declare function validatePriceRange(collectFeeMode: CollectFeeMode, sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1): void;
/**
 ...
 */
declare function validateInitialSqrtPrice(collectFeeMode: CollectFeeMode, initSqrtPrice: BN$1, sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1): void;
/**
 ...
 */
declare function validateCompoundingFee(collectFeeMode: CollectFeeMode, compoundingFeeBps: number): void;
/**
 ...
 */
declare function validateDynamicFee(dynamicFee: DynamicFee): void;
/**
 ...
 */
declare function validatePoolFees(poolFees: PoolFeesParams, collectFeeMode: CollectFeeMode, activationType: ActivationType, feeVersion?: number): void;
/**
 ...
 */
declare function validateCustomizablePoolParams(params: {
    collectFeeMode: number;
    activationType: number;
    sqrtMinPrice: BN$1;
    sqrtMaxPrice: BN$1;
 ...
 */
declare function validateTokenMints(tokenAMint: PublicKey, tokenBMint: PublicKey): void;
/**
 * Validates basic pool creation parameters for static-config pools.
 * @throws Error if any parameter is invalid.
 */
declare function validateCreatePoolParams(params: {
    tokenAMint: PublicKey;
    tokenBMint: PublicKey;
    liquidityDelta: BN$1;
    tokenAAmount: BN$1;
 ...
 */
declare function validateAddLiquidityParams(liquidityDelta: BN$1): void;
/**
 * Validates removeLiquidity parameters.
 * @throws InvalidParametersError if liquidityDelta is not positive.
 */
declare function validateRemoveLiquidityParams(liquidityDelta: BN$1): void;
/**
 ...
 */
declare function validateSplitPositionParams(params: {
    permanentLockedLiquidityPercentage: number;
    unlockedLiquidityPercentage: number;
    feeAPercentage: number;
    feeBPercentage: number;
 ...
 */
declare function validateSplitPosition2Params(numerator: number): void;
/**
 ...
 */
declare function getInitialCompoundingPoolInformation(sqrtPrice: BN$1, liquidity: BN$1): InitialPoolInformation;
/**
 ...
 */
declare function getAmountsForModifyForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, liquidity: BN$1, liquidityDelta: BN$1, round: Rounding): [BN$1, BN$1];
/**
 ...
 */
declare function calculateAtoBFromAmountInForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountIn: BN$1): SwapAmountFromInput;
/**
 ...
 */
declare function calculateBtoAFromAmountInForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountIn: BN$1): SwapAmountFromInput;
/**
 ...
 * @returns {SwapAmountFromInput} The result with output amount B and meta info
 */
declare function calculateAtoBFromPartialAmountInForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountIn: BN$1): SwapAmountFromInput;
/**
 ...
 * @returns {SwapAmountFromInput} The result with output amount A and meta info
 */
declare function calculateBtoAFromPartialAmountInForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountIn: BN$1): SwapAmountFromInput;
/**
 ...
 */
declare function calculateAtoBFromAmountOutForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountOut: BN$1): SwapAmountFromOutput;
/**
 ...
 */
declare function calculateBtoAFromAmountOutForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1, amountOut: BN$1): SwapAmountFromOutput;
/**
 ...
 */
declare function getReservesAmountForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1): [BN$1, BN$1];
/**
 ...
 */
declare function getNextSqrtPriceForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1): BN$1;
/**
 ...
 */
declare function getSqrtPriceFromAmountsForCompoundingLiquidity(tokenAAmount: BN$1, tokenBAmount: BN$1): BN$1;
/**
 ...
 */
declare function getAmountAFromLiquidityDeltaForCompoundingLiquidity(liquidityDelta: BN$1, tokenAAmount: BN$1, liquidity: BN$1, rounding: Rounding): BN$1;
/**
 ...
 */
declare function getAmountBFromLiquidityDeltaForCompoundingLiquidity(liquidityDelta: BN$1, tokenBAmount: BN$1, liquidity: BN$1, rounding: Rounding): BN$1;
/**
 ...
 */
declare function getPoolCreationAmountAFromLiquidityDeltaForCompoundingLiquidity(sqrtPrice: BN$1, liquidity: BN$1): BN$1;
/**
 ...
 */
declare function getPoolCreationAmountBFromLiquidityDeltaForCompoundingLiquidity(sqrtPrice: BN$1, liquidity: BN$1): BN$1;
/**
 ...
 */
declare function getLiquidityDeltaFromAmountAForCompoundingLiquidity(amountA: BN$1, tokenAAmount: BN$1, liquidity: BN$1): BN$1;
/**
 ...
 * @returns {BN} Liquidity delta (how much liquidity user can provide)
 */
declare function getLiquidityDeltaFromAmountBForCompoundingLiquidity(amountB: BN$1, tokenBAmount: BN$1, liquidity: BN$1): BN$1;
/**
 ...
 */
declare function getPoolCreationLiquidityDeltaFromAmountAForCompoundingLiquidity(amountA: BN$1, sqrtPrice: BN$1): BN$1;
/**
 ...
 * @returns {BN} Liquidity delta to use for pool creation
 */
declare function getPoolCreationLiquidityDeltaFromAmountBForCompoundingLiquidity(amountB: BN$1, sqrtPrice: BN$1): BN$1;
 ...
 */
declare function getInitialConcentratedLiquidityPoolInformation(sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1): InitialPoolInformation;
/**
 ...
 */
declare function getAmountsForModifyForConcentratedLiquidity(sqrtPrice: BN$1, sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1, liquidityDelta: BN$1, round: Rounding): [BN$1, BN$1];
/**
 ...
 */
declare function calculateAtoBFromAmountInForConcentratedLiquidity(sqrtMinPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountIn: BN$1): {
    outputAmount: BN$1;
    nextSqrtPrice: BN$1;
    amountLeft: BN$1;
};
 ...
 * @returns The swap result from exact input
 */
declare function calculateBtoAFromAmountInForConcentratedLiquidity(sqrtMaxPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountIn: BN$1): {
    outputAmount: BN$1;
    nextSqrtPrice: BN$1;
    amountLeft: BN$1;
};
 ...
 */
declare function calculateAtoBFromPartialAmountInForConcentratedLiquidity(sqrtMinPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountIn: BN$1): {
    outputAmount: BN$1;
    nextSqrtPrice: BN$1;
    amountLeft: BN$1;
};
 ...
 * @returns The swap result from partial input
 */
declare function calculateBtoAFromPartialAmountInForConcentratedLiquidity(sqrtMaxPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountIn: BN$1): {
    outputAmount: BN$1;
    nextSqrtPrice: BN$1;
    amountLeft: BN$1;
};
 ...
 */
declare function calculateAtoBFromAmountOutForConcentratedLiquidity(sqrtMinPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountOut: BN$1): {
    inputAmount: BN$1;
    nextSqrtPrice: BN$1;
};
/**
 ...
 * @returns The swap result from exact output
 */
declare function calculateBtoAFromAmountOutForConcentratedLiquidity(sqrtMaxPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1, amountOut: BN$1): {
    inputAmount: BN$1;
    nextSqrtPrice: BN$1;
};
/**
 ...
 */
declare function getReservesAmountForConcentratedLiquidity(sqrtPrice: BN$1, sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1, liquidity: BN$1): [BN$1, BN$1];
/**
 ...
 */
declare function getAmountBFromLiquidityDeltaForConcentratedLiquidity(lowerSqrtPrice: BN$1, upperSqrtPrice: BN$1, liquidity: BN$1, rounding: Rounding): BN$1;
/**
 ...
 */
declare function getAmountAFromLiquidityDeltaForConcentratedLiquidity(lowerSqrtPrice: BN$1, upperSqrtPrice: BN$1, liquidity: BN$1, rounding: Rounding): BN$1;
/**
 ...
 */
declare function getLiquidityDeltaFromAmountAForConcentratedLiquidity(amountA: BN$1, lowerSqrtPrice: BN$1, // current sqrt price
 ...
 */
declare function getLiquidityDeltaFromAmountBForConcentratedLiquidity(amountB: BN$1, lowerSqrtPrice: BN$1, // min sqrt price
upperSqrtPrice: BN$1): BN$1;

declare class CompoundingLiquidityHandler implements LiquidityHandler {
    tokenAAmount: BN$1;
    tokenBAmount: BN$1;
    liquidity: BN$1;
    constructor(tokenAAmount: BN$1, tokenBAmount: BN$1, liquidity: BN$1);
    getAmountsForModifyLiquidity(liquidityDelta: BN$1, round: Rounding): [BN$1, BN$1];
    calculateAtoBFromAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateBtoAFromAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateAtoBFromPartialAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateBtoAFromPartialAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateAtoBFromAmountOut(amountOut: BN$1): SwapAmountFromOutput;
    calculateBtoAFromAmountOut(amountOut: BN$1): SwapAmountFromOutput;
    getReservesAmount(): [BN$1, BN$1];
    getNextSqrtPrice(_nextSqrtPrice: BN$1): BN$1;
    getMaxAmountIn(_tradeDirection: TradeDirection): BN$1;
}
declare class ConcentratedLiquidityHandler implements LiquidityHandler {
    private sqrtMaxPrice;
    private sqrtMinPrice;
    private sqrtPrice;
    private liquidity;
    constructor(sqrtMaxPrice: BN$1, sqrtMinPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1);
    getAmountsForModifyLiquidity(liquidityDelta: BN$1, round: Rounding): [BN$1, BN$1];
    calculateAtoBFromAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateBtoAFromAmountIn(amountIn: BN$1): SwapAmountFromInput;
    calculateAtoBFromPartialAmountIn(amountIn: BN$1): SwapAmountFromInput;
    ...
    calculateBtoAFromAmountOut(amountOut: BN$1): SwapAmountFromOutput;
    getReservesAmount(): [BN$1, BN$1];
    getNextSqrtPrice(nextSqrtPrice: BN$1): BN$1;
    getMaxAmountIn(tradeDirection: TradeDirection): BN$1;
}
/**
 ...
 */
declare function getLiquidityHandler(poolState: PoolState): LiquidityHandler;
/**
 ...
 */
declare function getInitialPoolInformation(collectFeeMode: CollectFeeMode, sqrtMinPrice: BN$1, sqrtMaxPrice: BN$1, sqrtPrice: BN$1, liquidity: BN$1): InitialPoolInformation;
/**
 ...
 */
declare function getLiquidityDeltaFromAmountA(amountA: BN$1, sqrtPrice: BN$1, sqrtMaxPrice: BN$1, collectFeeMode: CollectFeeMode, tokenAAmount?: BN$1, liquidity?: BN$1): BN$1;
/**
 ...
 * @returns The liquidity delta (BN)
 */
declare function getLiquidityDeltaFromAmountB(amountB: BN$1, sqrtMinPrice: BN$1, sqrtPrice: BN$1, collectFeeMode: CollectFeeMode, tokenBAmount?: BN$1, liquidity?: BN$1): BN$1;
/**
 ...
 * - Concentrated: sqrtPrice-based formula
 */
declare function getAmountAFromLiquidityDelta(sqrtPrice: BN$1, sqrtMaxPrice: BN$1, liquidityDelta: BN$1, rounding: Rounding, collectFeeMode: CollectFeeMode, tokenAAmount?: BN$1, liquidity?: BN$1): BN$1;
/**
 ...
 */
declare function getAmountBFromLiquidityDelta(sqrtMinPrice: BN$1, sqrtPrice: BN$1, liquidityDelta: BN$1, rounding: Rounding, collectFeeMode: CollectFeeMode, tokenBAmount?: BN$1, liquidity?: BN$1): BN$1;
...
declare class FeeMarketCapScheduler implements BaseFeeHandler {
    ...
    validate(_collectFeeMode: CollectFeeMode, _activationType: ActivationType, feeVersion: number): boolean;
 ...
 */
declare function getBaseFeeHandlerFromPodAlignedData(rawData: number[]): BaseFeeHandler;
/**
 ...
 * @returns Base fee handler instance
 */
declare function getBaseFeeHandlerFromBorshData(rawData: number[]): BaseFeeHandler;
 ...
 */
declare function splitFees(poolFees: PoolFeesStruct, feeAmount: BN, hasReferral: boolean): SplitFees;
/**
 ...
 */
declare function getFeeOnAmount(poolFees: PoolFeesStruct, amount: BN, tradeFeeNumerator: BN, hasReferral: boolean): FeeOnAmountResult;
/**
 ...
 */
declare function getMaxFeeNumerator(feeVersion: number): BN;
/**
 * Gets the max fee bps
 * @param poolVersion - The pool version
 * @returns The max fee bps
 */
declare function getMaxFeeBps(feeVersion: number): number;
 ...
 */
declare function applySwapResult(poolState: PoolState, result: SwapResult2, feeMode: FeeMode, tradeDirection: TradeDirection): BN$1;
/**
